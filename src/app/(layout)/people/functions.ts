...
export async function updatePeople({
  ...
  if (id === undefined) dataMissingInBody.push('id')
  if (fullName === undefined) dataMissingInBody.push('fullName')
  if (titleIdFK === undefined) dataMissingInBody.push('titleIdFK')
  if (gender === undefined) dataMissingInBody.push('gender')
  if (address === undefined) dataMissingInBody.push('address')
  if (city === undefined) dataMissingInBody.push('city')
  if (suburb === undefined) dataMissingInBody.push('suburb')
  if (uf === undefined) dataMissingInBody.push('uf')
  if (cep === undefined) dataMissingInBody.push('cep')
  if (email === undefined) dataMissingInBody.push('email')
  if (isActive === undefined) dataMissingInBody.push('isActive')
  if (isMember === undefined) dataMissingInBody.push('isMember')
  if (addressNumber === undefined) dataMissingInBody.push('addressNumber')
  if (hasFamilyInChurch === undefined) dataMissingInBody.push('hasFamilyInChurch')
  if (relatives === undefined) dataMissingInBody.push('relatives')
  if (roles === undefined) dataMissingInBody.push('roles')
